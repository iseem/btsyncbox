# The listening ports are random, so feel free to change them. Just 
# be sure to change the corresponding lines in IPTABLES_CONFIG too.
...
# lines in the BT_SYNC_CONFIG. Port 22 is for SSH, port 45712 is 
# for BitTorrent, and 8888 is for the BTSync web interface.
...
.PHONY: all
all: update firewall fail2ban btsync clean reboot
